...
class _ProfileService implements ProfileService {
  ...
  @override
  Future<GetMyProfileResponseModel> getMyProfile() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetMyProfileResponseModel>(
    ...
    late GetMyProfileResponseModel _value;
    try {
      _value = GetMyProfileResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
