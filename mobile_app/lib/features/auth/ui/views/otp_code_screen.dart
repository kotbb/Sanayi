...
class OtpCodeScreen extends StatelessWidget {
  const OtpCodeScreen({super.key, required this.phoneNumber});
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    verticalSpace(36),
                    VerifyOtpBlocConsumer(phoneNumber: phoneNumber),
                    verticalSpace(24),
                    Row(
...
class VerifyOtpBlocConsumer extends StatelessWidget {
  final String phoneNumber;
  const VerifyOtpBlocConsumer({super.key, required this.phoneNumber});
    ...
    return BlocConsumer<VerifyOtpCubit, VerifyOtpState>(
      listener: (context, state) {
        if (state is VerifyOtpSuccess) {
          Navigator.pushReplacementNamed(context, Routes.chooseUserTypeScreen);
